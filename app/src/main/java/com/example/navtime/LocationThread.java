...
public class LocationThread extends Thread {
     ...
     * @param dados
     */
    public LocationThread(Context context, TextView textView, Data dados) {
    ...
    public void run() {
        ...
        while (isRunning) {
            ...
            try {
                Thread.sleep(300); // Aguarda 0.1 segundo para cada execução.
    ...
    public void startLocationUpdates() {
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                String localizacao = latitudeResultado + "\n"+longitudeResultado;
